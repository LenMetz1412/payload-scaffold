...
import { Button, buttonVariants } from '@/sha/button'
import { cn } from '@/utils/cn'

// SHOULD BE UNIFIED WITH ADMIN CALENDAR!
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn('bg-none rounded-l-md', defaultClassNames.range_start),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn('bg-none rounded-r-md', defaultClassNames.range_end),
        today: cn(
