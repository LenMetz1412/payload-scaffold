...
>(({ className, ...props }, ref) => (
  <div className={cn('absolute left-0 top-full mt-5 w-full')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'origin-top-left relative h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-2xl bg-nav text-nav-foreground shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90',
        className,
      )}
      ref={ref}
      {...props}
